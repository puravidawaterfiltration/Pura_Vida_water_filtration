const services = [
  {
    ...
    short: 'Remove chlorine, sediment, odor, and contaminants throughout the entire home.',
    icon: '💧',
    content: [
...
function HeaderWordmark() {
  return (
    <a href="#" className="group flex items-center gap-4 shrink-0">
      <div className="hidden sm:flex w-11 h-11 rounded-2xl border border-[#12B5E5]/40 bg-white/5 items-center justify-center relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#12B5E5]/20 to-[#FF3F8E]/20" />
        <div className="relative w-4 h-6 rounded-full border-2 border-[#12B5E5] after:content-[''] after:absolute after:w-2 after:h-2 after:rounded-full after:bg-[#FF3F8E] after:left-1/2 after:top-1/2 after:-translate-x-1/2 after:-translate-y-1/2" />
      </div>

      <div className="leading-none">
        <div className="text-[1.35rem] md:text-[1.65rem] font-black italic tracking-[0.16em] text-[#12B5E5] drop-shadow-[2px_2px_0px_#FF3F8E] group-hover:tracking-[0.19em] transition-all duration-300">
          PURA VIDA
        </div>
        <div className="mt-1 flex items-center gap-2">
          <span className="h-[2px] w-8 bg-[#FF3F8E]" />
          <span className="text-[0.58rem] md:text-[0.66rem] uppercase tracking-[0.32em] text-slate-300">
            Water Filtration
          </span>
        </div>
      </div>
  ...
  return (
    <main className="bg-white text-slate-900">
      <header className="fixed top-4 left-0 right-0 z-50 px-4">
        <div className="max-w-7xl mx-auto rounded-2xl bg-[#061225]/75 backdrop-blur-2xl border border-white/10 shadow-[0_20px_80px_rgba(0,0,0,0.25)]">
          <div className="px-5 md:px-7 py-3 flex items-center justify-between gap-8">
            ...
            <nav className="hidden lg:flex items-center gap-2 text-white text-[0.78rem] font-bold uppercase tracking-[0.16em]">
              {[
                ...
                <a
                  key={label}
                  href={href}
                  className="relative px-4 py-3 rounded-xl text-slate-200 hover:text-white transition group"
                >
                  {label}
                  <span className="absolute left-4 right-4 bottom-2 h-[2px] scale-x-0 bg-gradient-to-r from-[#12B5E5] to-[#FF3F8E] group-hover:scale-x-100 transition-transform origin-left" />
                </a>
              ))}
            </nav>
            ...
            <a
              href="mailto:info@puravidafiltration.com"
              className="hidden md:inline-flex bg-[#FF3F8E] hover:bg-[#ff5ca3] text-white px-5 py-3 rounded-xl font-black transition shadow-[0_0_25px_rgba(255,63,142,0.35)] hover:-translate-y-0.5"
            >
              Free Water Test
            </a>
            ...
            <a
              href="mailto:info@puravidafiltration.com"
              className="md:hidden text-white text-sm font-black bg-[#FF3F8E] px-4 py-3 rounded-xl"
            >
              Contact
            </a>
          </div>
